...
# Created: Fri Feb  1 04:38:09 CST 2013
#
#/ usage: aws:create  --key <>  --aws-access-key <>  --aws-secret-key <> [ --group <>]  --instance-type <m1.small>  --ami-id <>  --zone <us-east-1a>  --hostname <>  --purpose <>  --count <1> 
...
rerun_options_parse() {
    ...
    while [ "$#" -gt 0 ]; do
        ...
        case "$OPT" in
            ...
            --count) rerun_option_check $# $1; COUNT=$2 ; shift ;;
            # help option
            -?)
                rerun_option_usage
                exit 2
    ...
    [ -z "$COUNT" ] && COUNT="$(rerun_property_get $RERUN_MODULE_DIR/options/count DEFAULT)"
    ...
    [ -z "$COUNT" ] && { echo >&2 "missing required option: --count" ; return 2 ; }
